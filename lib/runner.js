...
exports.run = function (targets, root, sources) {
    var isWinOS = path.sep === '\\',
        ...
        MOCHA_PHANTOM_BIN = path.resolve(__dirname, '../node_modules/.bin/mocha-phantomjs' + (isWinOS ? '.cmd' : '')),
        ...
        function storeFinalCoverage() {
            ...
            istanbul.matcherFor({
                ...
                matcher.files.forEach(function(file) {
                    // As implemented here: https://github.com/gotwarlost/istanbul/blob/master/lib/command/common/run-with-cover.js#L222
