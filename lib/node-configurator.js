...
exports.configure = function (config, options) {
    ...
    if (typeof templateEngine.tech === 'string') {
        templateEngine.tech = require(templateEngine.tech);
    }
    if (typeof templateEngine.bemjsonTech === 'string') {
        templateEngine.bemjsonTech = require(templateEngine.bemjsonTech);
    }
    var TECH_SUFFIX = templateEngine.name,
        teOpts = {};
    _.assign(teOpts, templateEngine.options, {
