var path = require('path'),
    ...
    templateEngineDefault = {
        ...
        htmlTechOptionNames: { bemjsonFile: 'bemjson', templateFile: 'bemhtmlFile' }
    },
...
exports.configure = function (config, options) {
    ...
    htmlTechOpts[templateEngine.htmlTechOptionNames.templateFile] = '?.template.js';
        ...
        nodeConfig.addTechs([
            ...
            [mergeFiles, {
                ...
                sources: (options.langs ? ['?.i18n.js'] : []).concat(
                    '?.source.browser.js', '?.template.js', '?.pure.spec.js'
                )
            }],
            [modules, {
                target: '?.pre.spec.js',
