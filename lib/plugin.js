                    ...
                    .then(function (files) {
                        return vow.all(files.map(function (file) {
                            if (~options.fileSuffixes.indexOf(file.suffix)) {
                                ...
                                var filename = path.join(dstpath, bemname, bemname + '.base.deps.js');
                                ...
                                notation.modName && (dep.mod = notation.modName);

                                if (notation.modName && notation.modVal !== true) {
                                    dep.val = notation.modVal;
                                }

                                source = 'exports.deps = ' + JSON.stringify([dep]) + ';';
